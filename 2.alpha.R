...
acm2 <- alpha_hill_corr_plot(table = table_meta) #facet_orientation ="vertical")
...
ggsave("plots/alphas1.png", width = 13, height = 12, units = "in", dpi = 300)

alphas2 <- cowplot::plot_grid(acm2, a2,ncol = 1, rel_widths = c(1.2,1))
